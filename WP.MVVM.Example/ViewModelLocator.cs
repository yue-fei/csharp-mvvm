...
using WP.MVVM.Example.ViewModel;
using WP.MVVM.Core;

namespace WP.MVVM.Example
{
    ...
    public partial class ViewModelLocator
    {
        ...
        public MainPageViewModel MainPageViewModel
        {
            get
            {
                string key = GetViewModelKey(typeof(MainPageViewModel), string.Empty);
                if (ViewModels.ContainsKey(key))
                {
                    return (MainPageViewModel)ViewModels[key];
                }
                else
                {
                    return RegisterViewModel<MainPageViewModel>();
                }
            }
        }
